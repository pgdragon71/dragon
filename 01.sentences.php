...
<form action="02.wordguessing-1.php" method="get" autocomplete="off">
  ...
  <div class="question-box">
      ...
      <p><input type="text" placeholder="Enter" name="s6"/></p>
      </br>
      </br>
      07. <?php echo $random_sentences7?></br>
      <p><input type="text" placeholder="Enter" name="s7"/></p>
      </br>
